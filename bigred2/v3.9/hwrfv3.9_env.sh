...
source $HOME/model_configs/HWRF/v3.9/hwrfv3.9_modules.sh
####################################################
...
#                  HWRF v3.8a 
####################################################
##export HWRF_SCRATCH=/N/dc2/scratch/kkeshava/hwrfv3.8a
export HWRF_SCRATCH=/N/dcwan/projects/ckieu/kkeshava/hwrfv3.9
##alias hwrfv3.8c='cd /N/dc2/scratch/ckieu/hwrfv3.8a' hwrfv3.8='cd /N/dc2/scratch/kkeshava/hwrfv3.8a' hwrfout='cd /N/dc2/scratch/kkeshava/hwrfv3.8a/hwrfrun/output/pytmp/hwrfrun' hwrfwrapper='cd /N/dc2/scratch/kkeshava/hwrfv3.8a/hwrfrun/wrappers'
export WRF_DIR=${HWRF_SCRATCH}/hwrfrun/sorc/WRFV3
##
export LIB_W3_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_SP_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_SFCIO_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_BLAS_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_BACIO_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_NEMSIO_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
export LIB_G2_PATH=${HWRF_SCRATCH}/hwrfrun/sorc/hwrf-utilities/libs
