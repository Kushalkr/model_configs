...
source $HOME/model_configs/WRF-ARW/wrfarwv3.9_cray_modules.sh
####################################################
...
export NETCDF=/opt/cray/netcdf/4.4.1/CRAY/8.3
#export PNETCDF=/opt/cray/parallel-netcdf/1.6.1/CRAY/8.3
export PNETCDF=/opt/cray/parallel-netcdf/1.7.0/CRAY/8.3
export HDF5=/opt/cray/hdf5/1.10.0/CRAY/8.3
